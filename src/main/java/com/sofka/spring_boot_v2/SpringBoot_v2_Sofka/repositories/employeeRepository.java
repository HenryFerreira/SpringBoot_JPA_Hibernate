...
public interface employeeRepository extends JpaRepository<employee, Long> {//--> Indica que es una tabla de tipo
    ...
    employee findByFirstName(String firstName);//--> SELECT * FROM employee WHERE employeeId = '[parametro enviado]';
    employee findByLastName(String lastName);//--> SELECT * FROM employee WHERE employeeId = '[parametro enviado]';
}
