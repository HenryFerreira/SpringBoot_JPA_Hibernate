...
public interface employeeRepository extends JpaRepository<employee, Long>, CrudRepository<employee, Long> {//--> Indica
    // que es una tabla de tipo 'employee' y que su identificador(PrimaryKey) será de tipo Long
